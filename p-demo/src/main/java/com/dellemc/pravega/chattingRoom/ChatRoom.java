...
public class ChatRoom implements AutoCloseable {
    ...
    protected void receiveData() {
        while (true) {
            EventRead<byte[]> event = chatReader.readNextEvent(TIMEOUT_MILLIS);
            ...
            if (sent_file_recently) {
                ...
                EventRead<byte[]> fileEvent = chatReader.readNextEvent(TIMEOUT_MILLIS);
                continue;
            }
    ...
    protected ChatRoom(String selfName, int inboxHash) throws Exception {
